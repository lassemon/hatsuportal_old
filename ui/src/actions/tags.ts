...
interface ILoadingTagsAction extends Action {
  readonly type: FETCH_TAGS_LOADING_TYPE;
}

export const FETCH_TAGS_SUCCESS = 'FETCH_TAGS_SUCCESS';
export type FETCH_TAGS_SUCCESS_TYPE = typeof FETCH_TAGS_SUCCESS;
interface ISuccessTagsAction extends IPayloadAction<GetTagsPayload> {
...
interface IErrorTagsAction extends Action {
...
interface ICompleteTagsAction extends Action {
